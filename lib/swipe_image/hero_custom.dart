  ...
  Widget build(BuildContext context) {
    ...
    return Hero(
      ...
      flightShuttleBuilder: (BuildContext flightContext,
        ...
        print("flightDirection $flightDirection");
        if (flightDirection == HeroFlightDirection.pop) {
          print("slidePagekey  offset ${widget.slidePagekey.currentState?.offset}");
          print("slidePagekey  scale ${widget.slidePagekey.currentState?.scale}");
